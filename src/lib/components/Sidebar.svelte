...
<div class=" text-gray-500 dark:text-gray-400">
	{#if withTitle}
		<div
			class="text-lg font-bold text-gray-800 dark:text-gray-200 border-b border-gray-200 dark:border-gray-600 px-3 py-4"
		>
			<div class="flex gap-2 items-center">
				<img class="object-cover w-10 h-9" src={brands} alt="Office" />

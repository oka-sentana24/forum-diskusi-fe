...
<div class="border-b dark:border-teal-900 h-[11vh] relative">
  <div>
    ...
    <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200 px-6">Dashboard</h2>
  </div>
</div>

<main class="h-full overflow-y-auto">
  <div class="px-6 mx-auto grid py-5">
    <!-- Cards -->
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
      <!-- Card -->
      <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-blue-800">
        <div
